              ...
              <div class="grid grid-cols-3 gap-8">
                  ...
                  <ul class="space-y-1 font-light text-[#0A0A0A]">
                    <li>
                      <a href="#" class="text-[14px]">
                        {{ t("footer.account_text1") }}
                      </a>
                    </li>
                    <li>
                      <a href="#" class="text-[14px]">
                        {{ t("footer.account_text2") }}
                      </a>
                    </li>
                    <li>
                      <a href="#" class="text-[14px]">
                        {{ t("footer.account_text3") }}
                      </a>
                    </li>
                    <li>
                      <a href="#" class="text-[14px]">
                        {{ t("footer.account_text4") }}
                      </a>
                    </li>
                  </ul>
                </div>

                <!-- Saving & Investing Column -->
                <div>
                  <h3 class="font-bold text-[#333] text-[16px] mb-1">{{ t("footer.investing_title") }}</h3>
                  <ul class="space-y-1 font-light text-[#0A0A0A]">
                    <li>
                      <a href="#" class="text-[14px]">
                        {{ t("footer.investing_text1") }}
                      </a>
                    </li>
                    <li>
                      <a href="#" class="text-[14px]">
                        {{ t("footer.investing_text2") }}
                      </a>
                    </li>
                    <li>
                      <a href="#" class="text-[14px]">
                        {{ t("footer.investing_text3") }}
                      </a>
                    </li>
                    <li>
                      <a href="#" class="text-[14px]">
                        {{ t("footer.investing_text4") }}
                      </a>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul class="space-y-1 font-light text-[#0A0A0A]">
                    <li>
                      <a href="#" class="text-[14px]">
                        {{ t("footer.credits_text1") }}
                      </a>
                    </li>
                    <li>
                      <a href="#" class="text-[14px]">
                        {{ t("footer.credits_text2") }}
                      </a>
                    </li>
                    <li>
                      <a href="#" class="text-[14px]">
                        {{ t("footer.credits_text3") }}
                      </a>
                    </li>
                  </ul>
                </div>

                <!-- Cards Column — на всю ширину -->
                <div class="col-span-full">
                  <h3 class="font-bold text-[#333] text-[16px] mb-1">{{ t("footer.cards_title") }}</h3>
                  <ul class="space-y-1 font-light text-[#0A0A0A]">
                    <li>
                      <a href="#" class="text-[14px]">
                        {{ t("footer.cards_text1") }}
                      </a>
                    </li>
                    <li>
                      <a href="#" class="text-[14px]">
                        {{ t("footer.cards_text2") }}
                      </a>
                    </li>
                    <li>
                      <a href="#" class="text-[14px]">
                        {{ t("footer.cards_text3") }}
                      </a>
                    </li>
                    <li>
                      <a href="#" class="text-[14px]">
                        {{ t("footer.cards_text4") }}
                      </a>
                    </li>
                  </ul>
                </div>
